...
export class NotesController {
  ...
  @Post("addBranches")
  async addBranches(@Body() dto: { name:string }) {
    return this.notesService.addBranches(dto);
  }

  @Get("getAllBranches")
  async getAllBranches() {
    return this.notesService.getAllBranches();
  }

  @Post("deleteBranch")
  async deleteBranch(@Body() dto: { branchId: string }) {
    return this.notesService.deleteBranch(dto.branchId);
  }
